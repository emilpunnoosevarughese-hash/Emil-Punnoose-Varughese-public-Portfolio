          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <div className="mt-auto pt-16 pb-4 flex flex-col items-center justify-center select-none pointer-events-none">
                <p className="text-3xl md:text-5xl font-display font-black text-transparent bg-clip-text bg-gradient-to-b from-white/40 to-white/10 uppercase tracking-widest text-center leading-tight">
